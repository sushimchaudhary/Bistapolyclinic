...
const DoctorPage = () => {
  ...
  return (
    ...
    //         <div
    //           key={doc._id}
    //           className="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden flex flex-col" // Fixed height
    //         >
    ...
    //     {/* 
    //     <h2 className="text-3xl text-center py-3  font-semibold mb-6 text-gray-800">📋 Doctors List</h2>
